...
class CIFAR100DyNAActivationSinePerFeature(nn.Module):
    def __init__(
        self,
    ):
        ...
        self.a_activation_post = ModulatedActivationSine(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        ...
        self.b_activation_pre = ModulatedActivationSine(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        self.b_conv_post = nn.Conv2d(conv_features, conv_features, 3, 2, 1)
        self.b_activation_post = ModulatedActivationSine(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        ...
        self.c_activation_pre = ModulatedActivationSine(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        self.c_conv_post = nn.Conv2d(conv_features, conv_features, 3, 2, 1)
        self.c_activation_post = ModulatedActivationSine(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
