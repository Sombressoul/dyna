...
class CIFAR100DyNAActivationBellADPerFeature(nn.Module):
    def __init__(
        self,
    ):
        super(CIFAR100DyNAActivationBellADPerFeature, self).__init__()

        count_modes = 21
        conv_features = 32
        # Baseline: 38%
        # ModulatedActivationBellAD: 40%
        # Training time (s): 296.46
        self.baseline = False

        self.a_conv_pre = nn.Conv2d(3, conv_features, 3, 1, 1)
        self.a_activation_pre = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        self.a_conv_post = nn.Conv2d(conv_features, conv_features, 3, 2, 1)
        self.a_activation_post = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        ...
        self.b_activation_pre = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        self.b_conv_post = nn.Conv2d(conv_features, conv_features, 3, 2, 1)
        self.b_activation_post = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        ...
        self.c_activation_pre = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        self.c_conv_post = nn.Conv2d(conv_features, conv_features, 3, 2, 1)
        self.c_activation_post = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=conv_features,
        )
        ...
        self.d_activation = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=96,
        )
        ...
        self.e_activation = ModulatedActivationBellAD(
            passive=False,
            count_modes=count_modes,
            features=100,
        )
