...
# > python -m dyna.lib.cpsf.benchmark.benchmark_CPSF_T_New_vs_T_classic_window --N 4 --M 4 --S 16 --W 3  --batch 1  --dtype_z c64 --dtype_T c64 --device cuda --iters 100 --warmup 5 --etol_abs 1e-5 --etol_rel 1e-5 --per_iter
