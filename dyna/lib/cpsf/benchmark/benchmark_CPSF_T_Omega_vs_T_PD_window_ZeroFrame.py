# > python -m dyna.lib.cpsf.benchmark.benchmark_CPSF_T_Omega_vs_T_PD_window_ZeroFrame --N 4 --M 8 --S 16 --batch 8 --dtype_z c64 --dtype_T c64 --device cuda --iters 25 --warmup 5
# > python -m dyna.lib.cpsf.benchmark.benchmark_CPSF_T_Omega_vs_T_PD_window_ZeroFrame --N 32 --M 256 --S 16 --batch 256 --dtype_z c64 --dtype_T c64 --device cuda --iters 25 --warmup 5
...
def main():
    ...
    print("\n=== Numeric equivalence: T_PD_window(W=0) vs T_Omega (zero) ===")
    ...
    print("\n=== Summary ===")
    print(
        f"PD (W=0) avg: {t_c:.3f} ms | Omega (n=0) avg: {t_o:.3f} ms | speedup: {speedup:.2f}×"
    )
