...
class DynamicAutoencoder(nn.Module):
    def __init__(
        ...
        dynamic_conv_n_subspaces = 16
        dynamic_conv_rank_subspace = 16
        dynamic_conv_rank_transformations = 16
        ...
        cfg_dyn_conv_ds = dict(
            ...
            n_subspaces=dynamic_conv_n_subspaces,
            rank_subspace=dynamic_conv_rank_subspace,
            rank_transformations=dynamic_conv_rank_transformations,
            kernel_size=[3, 3],
            stride=[2, 2],
            padding=[0, 0, 0, 0],
        ...
        # =====> ENCODE
        # 256>128
        self.dyn_encode_01 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_ds | dict(in_channels=3))
        self.dyn_encode_01_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 128>64
        self.dyn_encode_02 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_ds)
        self.dyn_encode_02_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 64>32
        self.dyn_encode_03 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_ds)
        self.dyn_encode_03_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 32>16
        self.dyn_encode_04 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_ds)
        self.dyn_encode_04_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 16>8
        self.dyn_encode_05 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_ds)
        self.dyn_encode_05_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # =====> DECODE
        # 8>16
        self.dyn_decode_05 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_us)
        self.dyn_decode_05_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 16>32
        self.dyn_decode_04 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_us)
        self.dyn_decode_04_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 32>64
        self.dyn_decode_03 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_us)
        self.dyn_decode_03_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 64>128
        self.dyn_decode_02 = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_us)
        self.dyn_decode_02_norm = nn.BatchNorm2d(**cfg_dyn_norm)

        # 128>256
        self.dyn_decode_01_a = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_us)
        self.dyn_decode_01_b = dyna.module.DynamicConv2DMobius(**cfg_dyn_conv_ds | dict(out_channels=3))
